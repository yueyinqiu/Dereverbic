...
from models.dereverbic_models.tdunet_dbe_model_without_skip_connection import TdunetDbeModelWithoutSkipConnection
from trainers.trainer import Trainer


def test(model: TdunetDbeModelWithoutSkipConnection, 
...
def main():
    from exe.dereverbic.tdunet_dbe_without_skip_connection import test_tdunet_dbe_without_skip_connection_config as config

    print("# Loading...")
    test(TdunetDbeModelWithoutSkipConnection(config.device), 
