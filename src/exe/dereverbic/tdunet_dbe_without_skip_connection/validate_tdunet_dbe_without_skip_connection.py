...
def main():
    from exe.dereverbic.tdunet_dbe_without_skip_connection import validate_tdunet_dbe_without_skip_connection_config as config
    ...
    model: TdunetDbeModelWithoutSkipConnection = TdunetDbeModelWithoutSkipConnection(config.device)
